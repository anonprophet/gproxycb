...
public:
	...
	~CBNCSUtilInterface( );
        ...
        bool HELP_SID_AUTH_CHECK( bool TFT, QString war3Path, QString keyROC, QString keyTFT, QString valueQStringFormula, QString mpqFileName, QByteArray clientToken, QByteArray serverToken );
